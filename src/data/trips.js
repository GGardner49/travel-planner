export const trips = [
  ...
  },
  {
    ...
    accommodationName: "TBD AirBnb", accommodationAddress: "",
    accommodationType: "AirBnb",
    accomCost: "$600", flights: "$0 (business)", groundTransport: "$0",
    foodActivEst: "TBD", totalEst: "$600", expensed: "$0",
    outOfPocket: "$600", status: "BOOKED",
    notes: "Personal leg of May trip. Flights paid by business.",
  },
  {
    id: "3", year: 2026,
    ...
    outOfPocket: "$0", status: "BOOKED",
    notes: "100% expensed through GST. No personal cost.",
  },
  {
    id: "4", year: 2026,
...
export const yearTotals = {
  2026: { label: "~$7,400–$8,850", notes: "Orlando + Indian Rocks Beach + Bristol + Asheville/Blue Ridge + Winston ×2 + Maui. Work trips $0." },
