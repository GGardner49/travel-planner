export const trips = [
  ...
  },
  {
    ...
    notes: "100% expensed through GST. No personal cost. Airbnb at 104 W Emma St (South Seminole Heights). Short drive: Common Dialect Beerworks (baby-friendly taproom, toys + games), Florida Ave Brewing Co., Rooster & the Till (Michelin Bib Gourmand). Farther drive: Florida Aquarium (free under 2, nursing room on-site), Tampa Riverwalk + Sparkman Wharf (stroller-friendly waterfront food hall), ZooTampa at Lowry Park (free under 2), Armature Works / Heights Public Market (river views, food hall).",
  },
  {
    id: "4", year: 2026,
