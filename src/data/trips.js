export const trips = [
  ...
  },
  {
    ...
    activities: [
      { type: "beach", name: "Gulf Beach Access", desc: "~5 min walk from Airbnb — calm, shallow Gulf water" },
      { type: "park", name: "Kolb Park", desc: "Walkable — bay side park, picnic tables + restrooms" },
      { type: "restaurant", name: "Crabby Bill's", desc: "Casual seafood + live music, Gulf Blvd (short drive)" },
      { type: "restaurant", name: "Guppy's on the Beach", desc: "Waterfront seafood, great sunset views (short drive)" },
      { type: "restaurant", name: "Keegan's Seafood Grille", desc: "Local neighborhood fave (short drive)" },
      { type: "brewery", name: "3 Daughters Brewing", desc: "~15 min drive, Clearwater — family friendly" },
      { type: "brewery", name: "Clearwater Brewing", desc: "~15 min drive — outdoor seating" },
  ...
  },
  {
    ...
    activities: [
      { type: "brewery", name: "Common Dialect Beerworks", desc: "Short drive — baby-friendly taproom, toys + games on-site" },
      { type: "brewery", name: "Florida Ave Brewing Co.", desc: "Short drive — Seminole Heights, same corridor" },
      { type: "restaurant", name: "Rooster & the Till", desc: "Short drive — Michelin Bib Gourmand" },
      { type: "activity", name: "Florida Aquarium", desc: "Free under 2, nursing room on-site" },
      { type: "activity", name: "Tampa Riverwalk + Sparkman Wharf", desc: "Stroller-friendly waterfront food hall" },
      { type: "activity", name: "ZooTampa at Lowry Park", desc: "Free under 2, stroller-friendly paths" },
      { type: "activity", name: "Armature Works", desc: "River views, large indoor food hall" },
    ],
